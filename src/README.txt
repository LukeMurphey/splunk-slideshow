...
Once the app is installed, you can use the app by configuring a new slideshow:

  1. Open the "Slideshow" app from the main launcher.
  2. Select the views you want to show in the slideshow
  3. Press play to begin the show
...
|---------|------------------------------------------------------------------------------------------------------------------|
| 2.5.1   | Fixed issue where the slideshow did not execute correctly                                                        |
|---------|------------------------------------------------------------------------------------------------------------------|
| 2.6     | Added ability to hide the progress-bar (useful for remote displays such as X11 over SSH)                         |
|---------|------------------------------------------------------------------------------------------------------------------|
| 2.6.1   | Fixed App inspect issues                                                                                         |
|---------|------------------------------------------------------------------------------------------------------------------|
| 2.6.2   | Fixed App inspect issues                                                                                         |
+---------+------------------------------------------------------------------------------------------------------------------+
